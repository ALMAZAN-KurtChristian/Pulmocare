...
const HIW_user = () => {
  ...
  return (
    ...
    <div className='bg_HIW'>
      <Navbar_user userProfile={userProfile} />
    <div className="scrollable01-container">
      {loading && (
